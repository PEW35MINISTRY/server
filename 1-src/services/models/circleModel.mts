...
export default class CIRCLE implements BASE_MODEL  {
    ...
    #propertyList = [...this.#publicPropertyList, 'announcementList', 'prayerRequestList', 'memberList', 'pendingRequestList', 'pendingInviteList'];
    ...
    toJSON = ():DATABASE_CIRCLE => Object.fromEntries(this.getValidProperties()) as unknown as DATABASE_CIRCLE;

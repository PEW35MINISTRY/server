...
import { POST_circleReport, POST_contentReport, POST_prayerRequestCommentReport, POST_prayerRequestReport, POST_userReport } from './1-api/2-auth/moderation.mjs';
...
apiServer.post('/api/prayer-request/:prayer/report', POST_prayerRequestReport);
apiServer.post('/api/prayer-request/:prayer/comment/:comment/report', POST_prayerRequestCommentReport);
...
apiServer.post('/api/user/:client/report', POST_userReport);
...
apiServer.post('/api/circle/:circle/report', POST_circleReport);
...
apiServer.post('/api/content-archive/:content/report', POST_contentReport);
